#undef PLAYTIME_MULTIPLAYER_API
...
#define UE_PROJECT_NAME Playtime_Multiplayer
#define UE_TARGET_NAME Playtime_MultiplayerEditor
#define UE_MODULE_NAME "Playtime_Multiplayer"
...
#define PLAYTIME_MULTIPLAYER_API DLLEXPORT
